...
import SkeletonHalfSizeCard from './SkeletonHalfSizeCard';
...
const ScheduleJobLightCard = ({ isLoading, total, icon, label }) => {
  const theme = useTheme();

  return (
    <>
      {isLoading ? (
        <SkeletonHalfSizeCard />
      ) : (
...
ScheduleJobLightCard.propTypes = {
...
export default ScheduleJobLightCard;
